...
{
void init_thread_variables(int64_t local_id = 0, executor *owner_executor = nullptr);
...
inline thread_local executor *tl_owner_executor;
} // namespace pot::details::this_thread

namespace pot::this_thread
{
void init_thread_variables(const int64_t local_id = 0, executor *owner_executor = {});
